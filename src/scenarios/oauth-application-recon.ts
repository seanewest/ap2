...
export const OAUTH_APPLICATION_RECON_SCENARIO = parseScenarioManifest({
  ...
  actors: [
    ...
    {
      id: "recon-recovery-administrator",
      label: "Independent recovery administrator",
      kind: "human",
      summary:
        "Retains a separate administrative path without acting as workload or detector.",
    },
  ],
  roles: {
    ...
    producerPermissions: [
      {
        ...
        applicationRoleId: "98830695-27a2-44f7-8c18-0c3ebc9698f6",
        name: "GroupMember.Read.All",
      },
      {
        resourceApplicationId: "00000003-0000-0000-c000-000000000000",
        applicationRoleId: "810c84a8-4a9e-49e6-bf7d-12d183f40d01",
        name: "Mail.Read",
      },
      {
        resourceApplicationId: "00000003-0000-0000-c000-000000000000",
        applicationRoleId: "01d4889c-1287-42c6-ac1f-5d1e02578ef6",
        name: "Files.Read.All",
      },
    ],
    detectorPermissions: [
      {
        resourceApplicationId: "00000003-0000-0000-c000-000000000000",
        applicationRoleId: "b0afded3-3588-46d8-8b3d-9842eff778da",
  ...
  permissions: [
    {
      id: "recon-group-membership-read",
      kind: "graph-app-role",
      name: "GroupMember.Read.All",
      actorId: "recon-workload-app",
      scope: "Microsoft Graph application",
      purpose: "Read bounded directory memberships.",
      mode: "retained",
      retentionRationale: "Dedicated read-only reconnaissance authority.",
    },
    {
      id: "recon-mail-read",
      kind: "graph-app-role",
      ...
      actorId: "recon-workload-app",
      scope: "Microsoft Graph application",
      purpose: "Read bounded mailbox folders.",
      mode: "retained",
      retentionRationale: "Dedicated read-only reconnaissance authority.",
    },
    {
      ...
      actorId: "recon-workload-app",
      scope: "Microsoft Graph application",
      purpose: "Read the fixed OneDrive and SharePoint drive roots.",
      mode: "retained",
      retentionRationale: "Dedicated read-only reconnaissance authority.",
    },
    {
      ...
      mode: "retained",
      retentionRationale: "Dedicated detector read-only authority.",
    },
  ],
  evidence: {
    staging:
