...
const verifierUrl = new URL(
  "./verify-private-document-rehearsal-output.ts",
  import.meta.url,
).href;
const {
  ...
  typeof import("./verify-private-document-rehearsal-output.ts");
...
function main(args: readonly string[]): number {
  ...
  try {
    ...
    const summary = verifyPrivateDocumentRehearsalOutputText(
