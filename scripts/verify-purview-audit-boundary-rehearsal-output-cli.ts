...
const verifierUrl = new URL(
  "./verify-purview-audit-boundary-rehearsal-output.ts",
  import.meta.url,
).href;
const {
  ...
  typeof import("./verify-purview-audit-boundary-rehearsal-output.ts");
...
function main(args: readonly string[]): number {
  ...
  try {
    ...
    const summary = verifyPurviewAuditBoundaryRehearsalOutputText(
