...
const moduleUrl = new URL("./avd-three-vm-rehearsal.ts", import.meta.url).href;
const { runAvdThreeVmRehearsal } = await import(moduleUrl) as
  typeof import("./avd-three-vm-rehearsal.ts");
