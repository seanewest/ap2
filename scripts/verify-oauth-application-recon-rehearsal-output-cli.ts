...
const verifierUrl = new URL(
  "./verify-oauth-application-recon-rehearsal-output.ts",
  import.meta.url,
).href;
const {
  ...
  typeof import("./verify-oauth-application-recon-rehearsal-output.ts");
...
function main(args: readonly string[]): number {
  ...
  try {
    ...
    const summary = verifyOauthApplicationReconRehearsalOutputText(
