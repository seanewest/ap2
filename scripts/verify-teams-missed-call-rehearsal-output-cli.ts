...
const verifierUrl = new URL(
  "./verify-teams-missed-call-rehearsal-output.ts",
  import.meta.url,
).href;
const {
  ...
  typeof import("./verify-teams-missed-call-rehearsal-output.ts");
...
function main(args: readonly string[]): number {
  ...
  try {
    ...
    const summary = verifyTeamsMissedCallRehearsalOutputText(
