...
const verifierUrl = new URL(
  "./verify-avd-three-vm-rehearsal-output.ts",
  import.meta.url,
).href;
const {
  ...
  typeof import("./verify-avd-three-vm-rehearsal-output.ts");
...
function main(args: readonly string[]): number {
  ...
  try {
    ...
    const summary = verifyAvdThreeVmRehearsalOutputText(
    ...
    return fail(
      error instanceof RehearsalOutputVerificationError
        ? error.category
        : "INPUT_SHAPE",
    );
  }
