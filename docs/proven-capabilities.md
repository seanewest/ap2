...
- One marked Homer/Cory/Kobe/Marge Teams group chat and its single harmless
  Homer-authored message are retained for learner investigation and a later
  membership-remediation exercise. Protected cleanup identities remain outside
  Git.
